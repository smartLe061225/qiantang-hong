    ...
    <div>
        <Form ref="create_cert_form" :model="certification.data" :rules="certification.rules" :label-width="120">
            ...
            <FormItem label="公司logo" prop="logo">
                <div class="logo-box">
                    ...
                    :format="['jpg','jpeg','png']"
                        ...
                        :on-exceeded-size="handle_max_size"
            ...
            <FormItem label="公司名称" prop="name">
                <Input placeholder="请输入公司名称" v-model="certification.data.name" style="width:300px;"></Input>
            </FormItem>
            ...
            <FormItem label="上传资质材料" prop="license">
                <ul class="license-upload-list clearfix">
                    <li class="license-upload-item">
                        ...
                        :max-size="2048"
                        :on-format-error="handle_format_error"
                        :on-exceeded-size="handle_max_size" :show-upload-list="false" :on-success="handle_businesslicense_success" style="display: inline-block;">
            ...
            <FormItem label="">
                <Button type="primary" size="large" @click="post_enterprise">保存资料</Button>
            </FormItem>
        </Form>
